...
pub mod single {
    ...
    use crate::validation::{assert_all_positive, assert_min_period, assert_non_empty, assert_period, assert_positive, unsupported_type};
    ...
    pub fn mcginley_dynamic(
        ...
        assert_positive("period", period as f64);
