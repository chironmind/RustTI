...
- Added new deviation indicators:
  ...
  - cauchy_iqr_scale
- AbsDevSpec and DeviationAggregate to allow caller to specify which aggregate to use for absolute deviation calculations
...
- absolute_deviation now uses AbsDevSpec to allow caller to specify which aggregate to use
